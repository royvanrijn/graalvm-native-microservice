...
/**
 * Shadow class for ArchiveHelper from Hibernate 5.3.6, this class fixes a small bug in combination with GraalVM.
 * (String overflow caused by Resource handling with GraalVM)
 */
    ...
    public static URL getJarURLFromURLEntry(URL url, String entry) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Unable to determine JAR Url from " + url + ". Cause: " + e
            );
        }
